...
FADE_TIME = 15  # Fade In + Out times in seconds
...
class SquareServer(object):
    ...
    def _create_services(self):
        ...
        self.runner = ShowRunner(self.square_model,
                                 self.square_simulator,
                                 args.max_time,
                                 self.square_simulator.get_channel())
    ...
    def stop(self):
        if self.running:  # should be safe to call multiple times
            try:
                ...
                print ("Exception stopping Squares! {}".format(e))
                traceback.print_exc()
...
if __name__ == '__main__':
    ...
    print ("Using Square Simulator at {}:{}-{}".format(sim_host, sim_port, sim_port + NUM_CHANNELS - 1))
