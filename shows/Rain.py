...
from color import RGB, randColorRange
	...
	def next_frame(self):
		...
		while (True):
			...
			for i in range(self.density):
				self.raindrops.add_brick(randColorRange(self.blue, 0.05), life=self.square.height + 2,
			...
			if oneIn(500):
				self.square.set_all_cells(RGB(255, 255, 100))
