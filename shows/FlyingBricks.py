	...
	def next_frame(self):
		...
		while (True):
			...
			if oneIn(self.density):	# Regular bricks heading right
				...
				self.bricks.add_brick(wheel(randColorRange(self.color, brick_length * 10)),
									  life=20 + (self.square.width / brick_speed),
			...
			if oneIn(200):	# White bricks heading left
				...
				self.bricks.add_brick((255, 255, 255), life=20 + (self.square.width / brick_speed),
